...
from pyanalytics.kpi2.metrics.conversion_utils.processor import time_based_funnel
import logging
...
print (time_based_funnel(app_open_vmetro_query, []))
