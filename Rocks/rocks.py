...
# list of images to make random choice of them
debris_choice = list(['debris1_brown.png', 'debris2_brown.png', 'debris3_brown.png', 'debris4_brown.png', 'debris1_blue.png', 'debris2_blue.png', 'debris3_blue.png', 'debris4_blue.png', 'debris_blend.png'])
nebula_choice = list(['nebula_brown.png', 'nebula_blue.png'])
missile_choice = list(['shot1.png', 'shot2.png', 'shot3.png'])
asteroid_choice = list(['asteroid_blue.png', 'asteroid_brown.png', 'asteroid_blend.png'])
explosion_choice = list(['explosion_orange.png', 'explosion_blue.png', 'explosion_blue2.png', 'explosion_alpha.png'])
...
def group_collide(set_grp,other_object):
    for i in set(set_grp):
        if i.collide(other_object):
            set_grp.remove(i)
            return True
    return False

def group_group_collide(first, second):
    for i in set(first):
          if group_collide(second,i) == True:
                first.remove(i)
                return True
...
def draw(canvas):
    global time, started, lives, score, rock_group, number
